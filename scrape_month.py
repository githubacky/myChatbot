...
def main_concert_month():
	url = 'https://i-amabile.com/2020-07'
	html = fetch(url)
...
def scrape(html: str, base_url: str) -> List[dict]:
	...
	for idx in range(2, 12, 2):
		# #content > div > a:nth-child(7)
		# #content > div > p:nth-child(5)
		# #content > div > b:nth-child(6) > a
		# #content > div > b:nth-child(9) > a
		# #content > div > p:nth-child(12)
		# #content > div > b:nth-child(13) > a
